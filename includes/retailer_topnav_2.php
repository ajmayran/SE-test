<nav class="container flex justify-between py-4 mx-auto bg-white shadow-sm min-h-20">
        ...
        <div class="flex items-center">
            ...
            <a href="retailer_profile.php"><div class="flex items-center cursor-pointer">
                ...
                <?php echo isset($_SESSION['retailer_fname']) ? htmlspecialchars($_SESSION['retailer_fname']) : 'Guest'; ?> <?php echo isset($_SESSION['retailer_lname']) ? htmlspecialchars($_SESSION['retailer_lname']) : 'Guest'; ?>
                </span>
            </div></a>
        </div>
    </nav>
