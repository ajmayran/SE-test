    ...
    <div class="flex">
        <aside class="w-1/4 min-h-screen mt-0.5 bg-white sidebar-menu">
            <ul class="m-10 ml-10 space-y-2">
                ...
                <hr class="border-gray-300 shadow-sm"/>
                <li class="group">
                    <a class="flex items-center px-4 py-1 hover:bg-green-300 hover:text-gray-100" href="dist_blocking.html"><iconify-icon icon="solar:money-bag-bold" class="ml-10 mr-1 text-xl text-green-500 icon"></iconify-icon>
                        ...
                        <tbody>
                          <tr class="text-sm border-b-2 border-gray-100">
                            <td class="flex items-center px-4 py-2 text-[12px] font-light">
                              <img src="../img/Products/rtc-cheesy-chicken-fingers.png" alt="Product" class="mr-2 rounded w-14 h-14">
                          ...
                          <tr>
                            <td class="flex items-center px-4 py-2 text-[12px] font-light">
                              <img src="../img/Products/rtc-chicken-siomai.png" alt="Product" class="w-12 h-12 mr-2 rounded">
                    ...
                    <div class="overflow-x-auto">
                      <table class="w-full table-auto">
                        ...
                        <tbody>
                          <tr>
                            <td class="flex items-center px-4 py-2 text-[12px] font-light">    
                              <img src="../img/Products/rtc-chicken-tocino.png" alt="Product" class="w-12 h-12 mr-2 rounded">
  ...
  <div class="absolute inset-0 flex items-center justify-center">
    ...
    <script>
        ...
        const pendingOrdersData = [
        {
          id: "346819EVG4ZUO",
          products: [
            { name: "Magnolia Ready to Cook Cheesy Chicken Fingers", price: 200, qty: 20, image: "../img/Products/rtc-cheesy-chicken-fingers.png" },
            { name: "Magnolia Ready to Cook Chicken Siomai", price: 200, qty: 10, image: "../img/Products/rtc-chicken-siomai.png" },
            { name: "Magnolia Ready to Cook Lumpia Shanghai Mix", price: 200, qty: 10, image: "../img/Products/rtc-chicken-tocino.png" },
          ],
...

        {
          id: "241911VGA2VIP",
          products: [
            { name: "Magnolia Ready to Cook Chicken Siomai", price: 200, qty: 20, image: "../img/Products/rtc-chicken-siomai.png" },
          ],
      ...
      const completedOrdersData = [
        {
          id: "563829HJV3AK",
          products: [
            { name: "Magnolia Ready to Cook Chicken Tocino", price: 250, qty: 10, image: "../img/Products/rtc-chicken-tocino.png" },
          ],
