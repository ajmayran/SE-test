...
$pendingOrders = $orderObj->fetchReturn($retailer_id);
?>
...
<body class="flex flex-col min-h-screen">
    ...
    <div class="container mx-auto mb-24 bg-gray-50">
        <ul class="flex border-b border-gray-200 tab-list">
            ...
            <a href="../retailer/retailer_return.php" class="flex-1 py-2 text-center cursor-pointer tab-item text-white bg-green-500 font-semibold ">Return/Refund</a>
        </ul>
