        ...
        <div class="container flex items-center justify-between px-4 py-4 mx-auto">
            ...
            <div class="flex items-center space-x-2">
                ...
                <div class="relative">
                    ...
                    <div id="notificationDropdown" class="absolute right-0 z-10 hidden w-48 bg-white border border-gray-300 shadow-lg">
                        <ul class="py-2">
                            <li class="px-4 py-2 hover:bg-gray-100">Notification 1</li>
                            <li class="px-4 py-2 hover:bg-gray-100">Notification 2</li>
                            <li class="px-4 py-2 hover:bg-gray-100">Notification 3</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div id="accountPopper" class="absolute right-0 z-10 hidden w-48 bg-white border border-gray-300 shadow-lg">
                        <ul class="py-2">
