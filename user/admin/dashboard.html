        ...
        <ul class="mt-4">
            ...
            <li class="mb-1 group">
                ...
                <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                    <li class="mb-4">
                        <a href="./products/acceptedProducts.html" class="text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Accepted Products</a>
                    </li>
                    <li class="mb-4">
                    ...
                    <li class="mb-4">
                        <a href="./products/pendingProducts.html" class="text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Pending Products</a>
                    </li> 
                    <li class="mb-4">
                        <a href="./products/rejectedProducts.html" class="text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Rejected Products</a>
                    </li> 
                </ul>
            </li>
            <li class="mb-1 group">
                ...
                <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                    <li class="mb-4">
                        <a href="./transactions/completedOrders.html" class="text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Completed order</a>
                    </li> 
                    <li class="mb-4">
                        <a href="./transactions/CancelledOrders.html" class="text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Cancelled order</a>
                    </li> 
                </ul>
            </li>
            <li class="mb-1 group">
                ...
                <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                    <li class="mb-4">
                        <a href="./retailers/pending.html" class="text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Pending Retailers</a>
                    </li> 
                    <li class="mb-4">
                    ...
                    <li class="mb-4">
                        <a href="./retailers/restricted.html" class="text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Restricted Retailers</a>
                    </li> 
                    <li class="mb-4">
                        <a href="./retailers/banned.html" class="text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Banned Retailers</a>
                    </li> 
                </ul>
            </li>
            <li class="mb-1 group">
            ...
            <div class="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2 lg:grid-cols-3">
                <div class="p-6 bg-white border border-gray-100 rounded-md shadow-md shadow-black/5">
                    <div class="flex justify-between mb-6">
                        ...
                        <div class="dropdown">
                            <button type="button" class="text-gray-400 dropdown-toggle hover:text-gray-600"><iconify-icon icon="mdi:more-horiz" class="text-lg"></iconify-icon></button>
                            <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[140px]">
                                <li>
                                    <a href="#" class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-blue-500 hover:bg-gray-50">Goto</a>
                                </li>
                                <li>
                    ...
                    <div class="flex justify-between mb-4">
                        <div>
                            <div class="flex items-center mb-1">
                                ...
                                <div class="p-1 rounded bg-emerald-500/10 text-emerald-500 text-[12px] font-semibold leading-none ml-2">+89%</div>
                            </div>
                ...
                <div class="p-6 bg-white border border-gray-100 rounded-md shadow-md shadow-black/5">
                    <div class="flex justify-between mb-6">
                        <div>
                            <div class="mb-1 text-2xl font-semibold"><span class="text-base font-normal text-gray-400 align-top"></span>2,345</div>
            ...
            <div class="grid grid-cols-1 gap-6 mb-6 lg:grid-cols-2">
                <div class="p-6 bg-white border border-gray-100 rounded-md shadow-md shadow-black/5">
                    ...
                    <div class="flex items-center mb-4 order-tab">
                        <button type="button" data-tab="order" data-tab-page="active" class="px-4 py-2 text-sm font-medium text-gray-400 bg-gray-50 rounded-tl-md rounded-bl-md hover:text-gray-600 active">Active</button>
                        <button type="button" data-tab="order" data-tab-page="completed" class="px-4 py-2 text-sm font-medium text-gray-400 bg-gray-50 hover:text-gray-600">Completed</button>
                        <button type="button" data-tab="order" data-tab-page="Cancelled" class="px-4 py-2 text-sm font-medium text-gray-400 bg-gray-50 rounded-tr-md rounded-br-md hover:text-gray-600">Cancelled</button>
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            ...
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Order 1</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                    ...
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="inline-block p-1 rounded bg-orange-100 text-orange-500 font-medium text-[12px] leading-none">In progress</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Order 2</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">3 days</span>
                                ...
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Order 3</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">3 days</span>
                                ...
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Order 4</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">3 days</span>
                                ...
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Order 5</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">3 days</span>
                        ...
                        <table class="w-full min-w-[540px]">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="dropdown">
                                            <button type="button" class="flex items-center justify-center w-6 h-6 text-sm text-gray-400 rounded dropdown-toggle hover:text-gray-600 bg-gray-50"><iconify-icon icon="mdi:more-vert" class="text-lg"></iconify-icon></button>
                                            <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[140px]">
                                                <li>
                                                    <a href="#" class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-blue-500 hover:bg-gray-50">Goto</a>
                                                </li>
                ...
                <div class="p-6 bg-white border border-gray-100 rounded-md shadow-md shadow-black/5">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-[460px]">
                            <thead>
                                <tr>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-400 py-2 px-4 bg-gray-50 text-left rounded-tl-md rounded-bl-md">User</th>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-400 py-2 px-4 bg-gray-50 text-left">Rating</th>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-400 py-2 px-4 bg-gray-50 text-left rounded-tr-md rounded-br-md">Review</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Ramses Manalo</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex">
                                            <span class="-mr-1 text-yellow-300">★</span>
                                            <span class="-mr-1 text-yellow-300">★</span>
                                            <span class="-mr-1 text-yellow-300">★</span>
                                            <span class="-mr-1 text-yellow-300">★</span>
                                            <span class="-mr-1 text-yellow-300">★</span>
                                    ...
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="inline-block p-1 rounded font-medium text-[12px] leading-none">Kupal kaba boss</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Chase</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex">
                                    ...
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="inline-block p-1 rounded font-medium text-[12px] leading-none">Ewan</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Cyrus Bon Damian</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex">
                                    ...
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="inline-block p-1 rounded  font-medium text-[12px] leading-none">Nice two</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Missy Balano</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex">
                                    ...
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="inline-block p-1 roundedfont-medium text-[12px] leading-none">Tara Valo</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Ahmadnur Jul</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex">
                                    ...
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="inline-block p-1 rounded  font-medium text-[12px] leading-none">Sanaol</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Rey Flores</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex">
                                    ...
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="inline-block p-1 rounded  font-medium text-[12px] leading-none">Bro</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Ginalen Bejoc</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex">
                                    ...
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="inline-block p-1 rounded  font-medium text-[12px] leading-none">Very Demure</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Sharmaine Ambulah</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex">
                                    ...
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="inline-block p-1 rounded font-medium text-[12px] leading-none">???</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">Moises Javier</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex">
                                    ...
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="inline-block p-1 rounded  font-medium text-[12px] leading-none">Yes</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="block object-cover w-8 h-8 rounded">
                                            <a href="#" class="ml-2 text-sm font-medium text-gray-600 truncate hover:text-blue-500">John</a>
                                        </div>
                                    </td>
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <div class="flex">
                                    ...
                                    <td class="px-4 py-2 border-b border-b-gray-50">
                                        <span class="inline-block p-1 rounded font-medium text-[12px] leading-none">Why is this</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
