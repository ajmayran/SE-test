...
<head>
    ...
    <title>Active Distributors</title>
</head>
<style>
    body {
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main">
        ...
        <div class="p-6">
            ...
            <div class="p-6 bg-white rounded-lg shadow">
                <h2 class="text-2xl font-bold mb-6">Active Distributors</h2>
    ...
    <script>
        $(document).ready(function() {
            const distributorTable = [
                ["DistA00001", "Vicente De Leon", "VicenteDeLeon@gmail.com", "July 12, 2024", "Active"],
                ["DistA00002", "Teodoro Medina", "TeodoroMedina@gmail.com", "January 12, 2024", "Active"],
                ["DistA00003", "Roberto Cruz", "RobertoCruz@gmail.com", "January 12, 2024", "Active"],
                ["DistA00004", "Julio Reyes", "JulioReyes@gmail.com", "January 12, 2024", "Active"],
                ["DistA00005", "Pedro Santos", "PedroSantos@gmail.com", "January 12, 2024", "Active"],
                ["DistA00006", "Nestor De Leon", "NestorDeLeon@gmail.com", "July 12, 2024", "Active"],
                ["DistA00007", "Abigail Cruz", "AbigailCruz@gmail.com", "January 12, 2024", "Active"],
                ["DistA00008", "Dolores Bautista", "DoloresBautista@gmail.com", "January 12, 2024", "Active"],
                ["DistA00009", "Crisanto Perez", "CrisantoPerez@gmail.com", "January 12, 2024", "Active"],
                ["DistA00010", "Sofia Dela Cruz", "SofiaDelaCruz@gmail.com", "January 12, 2024", "Active",],
                ["DistA00011", "Olivia Rodrigo", "OliviaRodrigo@gmail.com", "January 12, 2024", "Active"],
                ["DistA00019", "Orlando Cali", "Orlando@gmail.com", "January 12, 2024", "Active"]
            ];

            $('#distributorTable').DataTable({
                data: distributorTable,
                columns: [
            ...
            $('#confirmRestrict').on('click', function () {
                ...
                alert(`Distributor restricted for ${days} day(s). Reason: ${reason}`);
            ...
            $('#confirmBan').on('click', function () {
                ...
                alert(`Distributor banned. Reason: ${reason}`);
