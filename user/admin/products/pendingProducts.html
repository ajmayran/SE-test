    ...
    // Initialize DataTable
            $('#productTable').DataTable({
                data: [
                    [
                        'PRC001',
                        '<img src="../../img/Products/rtc-chicken-lumpia.png" alt="Product 1" class="w-8 h-8 inline-block mr-2"> RTC Chicken Lumpia',
                        'Magnolia',
                        '250.00',
                        '11/14/2024',
                    ...
                    [
                        'PRC002',
                        '<img src="../../img/Products/rtc-chicken-bbq.png" alt="Product 2" class="w-8 h-8 inline-block mr-2"> RTC Chicken BBQ',
                        'Timplados',
                        '120.50',
                        '11/15/2024',
                        '<button class="approve-btn bg-green-500 text-white p-2 rounded hover:bg-green-600">Approve</button> <button class="bg-red-500 text-white p-2 rounded hover:bg-red-700">Delete</button>'
