    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main">
        ...
        <div class="sticky top-0 left-0 z-30 flex items-center px-6 py-2 bg-white shadow-md shadow-black/5">
            ...
            <ul class="flex items-center ml-4 text-sm">
                ...
                <li class="mr-2 font-medium text-gray-600">Rejected</li>
            </ul>
        ...
        <div class="p-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow mb-6">
                ...
                <!-- Modal for Remove -->
                <div id="remove-modal" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center hidden">
                    <div class="bg-white rounded-lg shadow-lg p-6 w-1/3">
                    <h2 class="text-xl font-bold mb-4">Remove Product</h2>
                    <p id="remove-modal-product-details" class="mb-4"></p>
                    <div class="flex justify-end space-x-4">
                        <button id="cancel-remove" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">Cancel</button>
                        <button id="confirm-remove" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600">Confirm Remove</button>
                    </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready( function () {
            $('#productTable').DataTable({  
                data: [ 
                    ['<img src="../../img/Products/rtc-chicken-lumpia.png" alt="Product 1" class="w-8 h-8 inline-block mr-2"> RTC Chicken Lumpia', 'Magnolia', '250.00', '11/14/2024', 'Not applicable', '<button class="bg-red-500 text-white p-2 rounded hover:bg-red-700">Delete</button>'],
                    ['<img src="../../img/Products/rtc-chicken-bbq.png" alt="Product 2" class="w-8 h-8 inline-block mr-2"> RTC Chicken BBQ', 'Timplados', '10,000.00', '11/15/2024', 'Overpriced', '<button class="bg-red-500 text-white p-2 rounded hover:bg-red-700">Delete</button>'],
                    ['<img src="../../img/Products/wrong-item.png" alt="Product 2" class="w-8 h-8 inline-block mr-2"> Yumyum Sarap', 'Ice Cream Man', '120.50', '11/15/2024', 'Wrong Information', '<button class="bg-red-500 text-white p-2 rounded hover:bg-red-700">Delete</button>'],
            ...
            const removeModalProductDetails = document.getElementById('remove-modal-product-details');
            ...
            document.querySelectorAll('.bg-red-500').forEach((button) => {
                ...
                const productName = selectedRow.children[0].textContent.trim();
                const distributor = selectedRow.children[1].textContent.trim();
                const price = selectedRow.children[2].textContent.trim();
                const date = selectedRow.children[3].textContent.trim();

                removeModalProductDetails.innerHTML = `
                    <strong>Product:</strong> ${productName}<br>
                    <strong>Distributor:</strong> ${distributor}<br>
            ...
            confirmRemoveButton.addEventListener('click', () => {
                ...
                dataTable.row(selectedRow).remove().draw(); // Remove the row from DataTable
