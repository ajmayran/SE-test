    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main">
        ...
        <div class="sticky top-0 left-0 z-30 flex items-center px-6 py-2 bg-white shadow-md shadow-black/5">
            ...
            <ul class="flex items-center ml-4 text-sm">
                ...
                <li class="mr-2 font-medium text-gray-600">Cancelled</li>
            </ul>
    ...
    <script>
        $(document).ready( function () {
            $('#orderTable').DataTable({  
                data: [ 
                    ['order001', 'user001', 'Jazzer Onggoy', 'Jacob Trading' , '11/14/2024', 'Complete'],
                    ['order002', 'user007', 'Rudeee Abao', 'Primus' , '11/15/2024', 'Complete'],
                    ['order001', 'user001', 'Kyluzz Wiffer', 'Primus' , '11/14/2024', 'Complete'],
                    ['order002', 'user007', 'Therty Carroz', 'New Horizon Distribution Corporation' , '11/15/2024', 'Complete'],
                    ['order001', 'user001', 'Daniba SK', 'Jacob Trading' , '11/14/2024', 'Complete'],
                    ['order002', 'user007', 'No sleep AJ', 'New Horizon Distribution Corporation' , '11/15/2024', 'Complete'],
                    ['order001', 'user001', 'Jazzer Onggoy', 'Jacob Trading' , '11/14/2024', 'Complete'],
                    ['order002', 'user007', 'No sleep AJ', 'New Horizon Distribution Corporation' , '11/15/2024', 'Complete'],
                    ['order001', 'user001', 'Jazzer Onggoy', 'Primus' , '11/14/2024', 'Complete'],
                    ['order002', 'user007', 'Kyluzz Wiffer', 'Primus' , '11/15/2024', 'Complete'],
                    ['order001', 'user001', 'Jazzer Onggoy', 'Primus' , '11/14/2024', 'Complete'],
                    ['order002', 'user007', 'No sleep AJ', 'Primus' , '11/15/2024', 'Complete'],
                    ['order003', 'user004', 'BuggerMan Emman', 'Jacob Trading' , '11/15/2024', 'Complete']
