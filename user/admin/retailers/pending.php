    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main">
        ...
        <div class="p-6">
            ...
            <div class="p-6 bg-white rounded-lg shadow">
                <h2 class="text-xl font-bold mb-4">Pending Retailers</h2>
                ...
                columns: [
                    ...
                    {"data": null,
                        "render": function (data, type, row) {
                            return '<div class="flex space-x-2"><button class="bg-green-500 hover:bg-green-600 text-white font-bold py-1 px-2 rounded">Accept</button><button class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded">Delete</button></div>';
                        }
                    }
                ]
            });
